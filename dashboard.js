...
function updateVolumeChart() {
    ...
    const programType = document.getElementById('volumeProgramFilter').value;
    ...
    const enrollmentsDatasets = reps.map(rep => ({
        ...
        backgroundColor: repColors[rep] + '50', // Semi-transparent
        borderColor: repColors[rep],
        borderWidth: 1,
        stack: 'Stack 0'
    }));
                ...
                legend: {
                    ...
                    labels: {
                        generateLabels: function(chart) {
                            // Create custom legend showing only rep names
                            return reps.map(rep => ({
                                text: rep,
