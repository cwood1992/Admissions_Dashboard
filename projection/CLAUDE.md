...
- **Known gap (2026-09-18):** the rate is seeded from snapshots 8-30d out, but calibration observes it at start (~3d out), where VIP/P-xx converts lower because eventual starters have become WBH by then -- expect calibration to drift it down. Separately, the model under-projects at 15-30d (untagged and later enrollees who start aren't in the tier math).
